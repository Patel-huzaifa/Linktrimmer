            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Link href="https://github.com/Patel-huzaifa/Linktrimmer" target="_blank">
                  <button className="px-8 py-4 border-2 border-gray-300 text-gray-700 font-semibold rounded-xl hover:border-purple-600 hover:text-purple-600 transition-all duration-300 flex items-center gap-2 cursor-pointer focus:outline-none">
                ...
                <div className="relative bg-white rounded-3xl p-8 shadow-2xl">
                  <div className="space-y-4">
                    ...
                    <div className="bg-gradient-to-r from-purple-100 to-blue-100 p-4 rounded-lg">
                      <div className="text-sm font-mono text-purple-600">linktrimer.com/abc123</div>
                    </div>
                    <div className="bg-gradient-to-r from-blue-100 to-indigo-100 p-4 rounded-lg">
                      <div className="text-sm font-mono text-blue-600">linktrimer.com/xyz789</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Why Choose LinkTrimer?</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 rounded-xl bg-gradient-to-br from-purple-50 to-purple-100">
              ...
              <p className="text-gray-600">Generate short URLs instantly with our optimized platform</p>
            </div>
            ...
            <div className="text-center p-6 rounded-xl bg-gradient-to-br from-blue-50 to-blue-100">
              ...
              <p className="text-gray-600">No tracking, no data collection, just pure URL shortening</p>
            </div>
            ...
            <div className="text-center p-6 rounded-xl bg-gradient-to-br from-indigo-50 to-indigo-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Manage Multiple</h3>
              <p className="text-gray-600">Create and manage multiple shortened URLs in one place</p>
            </div>
          </div>
        </div>
      </section>
