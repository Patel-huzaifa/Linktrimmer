...
const Shorten = () => {
  ...
  const validateShortUrl = (shortUrl) => {
    ...
    const reservedPaths = ["about", "shorten", "api", "admin", "login", "register"];
  ...
  const handleGenerate = async () => {
    ...
    if (!validateShortUrl(shortUrl)) {
      if (urls.some(item => item.shortUrl === shortUrl.trim())) {
        toast.error("This short URL already exists. Please choose a different one.");
      } else {
        toast.error("Short URL must be 1-50 characters, alphanumeric only, no spaces or dots");
      }
      return;
    }
          ...
          {urls.length > 0 && (
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <div className="space-y-4">
                {urls.map((urlItem) => (
                  <div key={urlItem.id} className="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow duration-200">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="mb-3">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              onClick={() => copyToClipboard(urlItem.generatedUrl)}
